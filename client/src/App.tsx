...
const GMDashboardSimplified = lazy(
  () => import("@/pages/gm-dashboard-simplified"),
);
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route
        path="/session/:sessionId/select-character"
      ...
      {isLoading || !isAuthenticated ? (
        ...
        <>
          ...
          <Route
            path="/character-creation/:sessionId"
            component={CharacterCreation}
          />
          <Route
            path="/character-edit/:sessionId/:id"
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <DiceSoundProvider>
        <TooltipProvider>
          <Toaster />
          <Suspense fallback={<div className="flex h-screen items-center justify-center text-aged-parchment">Chargement...</div>}>
            <Router />
          </Suspense>
        </TooltipProvider>
      </DiceSoundProvider>
